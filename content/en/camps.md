...
Jeder GM kann bis zu zwei Mal pro Saison jeweils bis zu acht Spieler (weniger sind möglich, ändert aber nichts an Dauer und Kosten) in ein Trainingscamp schicken. Wichtig ist hierbei, dass mindestens ein Basisteams bestehend aus je 6 Centern, Left Wings und Right Wings, 10 Defendern und 3 Goalies noch in der Franchise verbleiben und die Saisonspiele absolvieren. Bei den Angreifern ist jede einzelne Position wichtig, bei den Defendern die Tatsache ob Links- oder Rechtsschütze jedoch nicht von Belang.
...
In [Saisonverlauf, Regular Season](/season#die-regular-season-regseason) wird auf die Blöcke hingewiesen, in die die Regular Season eingeteilt wird. Diese sind bei der Planung der Trainingscamps sehr wichtig. Die Regular Season ist in zehn Blöcke aufgeteilt. Ein Block umfasst sechs Spieltage. Ab Saison 18: Tag 1-6 = Block 1, Tag 7-12 = Block 2, u.s.w.). Der Block 1 beginnt ab Spieltag 1. Der letzte Block (Nr. 10) Endet mit dem Beginn der Trading Deadline. Während eines Blocks ist es möglich, für den nächsten Block ein Camp zu buchen. Man kann also letztmalig ab Block 10 für dann maximal einen Block in ein Camp fahren. Diese Camper kommen entsprechend erst nach der Trading Deadline zurück.

Neu ab Saison 18 ist, dass man bereits ab Spieltag 1 (Block 1) in ein Camp fahren kann.
...
Sobald die Offseason beginnt, haben die GMs bis zum Start der UFA-Phase Zeit der Ligaleitung mitzuteilen, in welche Trainingscamps das eigene Team in der anstehenden Saison gehen wird. Dies geschieht über eine Mitteilung im Forum. Es wird dazu einen eigenen Thread pro Saison geben. Dabei wird zunächst lediglich mitgeteilt ob man einmal oder zweimal ins Camp fahren möchte und aus wie vielen Schwerpunkten die einzelnen Camps bestehen sollen. Wann genau die Camps starten sollen und welche Schwerpunkte genau verwendet werden sollen, wird an dieser Stelle nicht mitgegeben. Aus der Angabe der GMs ergeben sich die Kosten für die Durchführung der Trainingslager. Diese Kosten werden unmittelbar nach der Meldung des GMs direkt vom Salary Cap des jeweiligen Teams abgezogen. Zum Zeitpunkt der Mitteilung muss das Team genügend Cap-Space frei haben um diese Kosten tragen zu können.

Im Laufe der Saison kann die Anzahl der Camps nicht mehr angepasst werden. Hat man sich also im Vorfeld dazu entschieden nur ein Camp durchzuführen, kann man später nicht mehr auf zwei Camps umstellen. 

Wenn man sich im Vorfeld für die Durchführung von zwei Camps entscheiden hat, ist man zwar nicht verpflichtet diese tatsächlich durchzuführen, man hat jedoch keinen Anspruch darauf die Trainingslagergebühr zurückzubekommen, wenn man die Camps am Ende nicht nutzt.

Die spätere Buchung eines Camps erfolgt über die Website im Bereich: Office / Trainingscamps. Diese Buchung landet im TOHL-Reisebüro wo eine Prüfung vorgenommen wird. Der Manager erhält im Anschluss eine Bestätigungsmail von der Koordinationsstelle und hat dann die für das Trainingscamp vorgesehenen Spieler auf die Scratch-Liste zu setzen. Sollte es Probleme bei der Buchung geben, meldet sich das TOHL-Reisebüro bei dem jeweiligen GM. Das Lines-File (bzw. die Lines Erstellung auf der Homepage) ist bis spätestens 19.59 Uhr für den Spieltag (gleichzeitig Beginn des Trainingslagers) abzusenden. Spieler im Trainingscamp werden im Roster mit der Bezeichnung HO (holdout) gekennzeichnet. Es können zur selben Zeit unbegrenzt viele Teams ein und dasselbe Trainingscamp buchen. Nach dem Camp verbessern sich die Spieler entsprechend der Trainingsinhalte (deren Wichtigkeit durch die Sterne hervorgehoben ist).

Zum Zeitpunkt der Buchung prüft das TOHL-Reisebüro ob alle Kriterien erfüllt sind. Also vor allem ob die Anzahl der vorhandenen TL-Punkte nicht überschritten wird und ob die Mindestanzahl an Spielern pro Position eingehalten wird, wenn die Camper denn weg sein werden. Die Prüfung erfolgt ausschließlich zum Zeitpunkt der Buchung! Wenn sich zwischen der Bestätigung und Camp-Beginn noch etwas verändert, was nicht auf den GM zurückzuführen ist, hat dies keine Auswirkungen auf die Camp-Durchführung. Dies ist der Fall wen sich eine Sperre oder eine Verletzung (eines nicht Camp-Fahrers) ergibt. Sollte der GM durch eigenes Zutun, z.B. durch Entlassungen oder Trades die Anzahl der Mindestspieler unterschreiten, kann das Camp ggf. nicht durchgeführt werden.
